				...
				<div id="log">
				  <div id="registrate">
					<p>¿No tienes cuenta?</p>
					  <a href="#"><img src="../imagesAdidas/login/enviarRegistro.png" onclick="MM_goToURL('parent','/registro.php');return document.MM_returnValue"></a>
				  </div>
					<div id="login">
						...
						<div class="form">
						  <form ACTION="<?php echo $loginFormAction; ?>" METHOD="POST" class="log" name="login">
						    ...
						    <input type="text" value="usuario" name="usuario" onclick="if(this.value == 'usuario')this.value=''" onblur="if(this.value == '')this.value='usuario'"/></br>
							Password:
                            <input type="text" value="contraseña" name="password" onclick="if(this.value == 'contraseña')this.value=''" onblur="if(this.value == '')this.value='contraseña'"/></br>
						...
						<div class="userOptions">
						  <a href="registroFalla1.php">No puedo entrar a mi cuenta</a><br/>
