...
<div id="container">
			...
			<div id="content">
				...
				<div id="registro">
                <div id="error"></div>
<form action="<?php echo $editFormAction; ?>" method="get" id="form1" name="form1">
        ...
        <tr valign="baseline "class="short">
                    ...
                    <tr valign="baseline" class="short">
                      ...
                      <td><select name="id_dia_descanso">
                        <?php 
						do {  
     ...
     <?php endif;?>
        ...
        <tr valign="baseline">
           <?php endif;?>
                  ...
                  <tr valign="baseline">
                      <td align="right">&nbsp;</td>
                       <td><input type="image" src="../imagesAdidas/login/sol.png" class="enviarRegistro" onclick="MM_validateForm('nombre','','R','nombre','','R','apellido_paterno','','R','apellido_paterno','','R','apellido_materno','','R','apellido_materno','','R','email','','RisEmail','email','','RisEmail','password','','R','password','','R','telefono','','RisNum','telefono','','RisNum','celular','','RisNum','celular','','RisNum','nombre_jefe','','R','nombre_jefe','','R');return document.MM_returnValue" /></td>
