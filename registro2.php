...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  if (isset($_SERVER['QUERY_STRING'])) {
    $_SESSION['MM_Username'] = $_REQUEST['nombre'];
	$_SESSION['MM_UserPuesto'] = $_REQUEST['id_puesto'];
...
<body>
	...
	<table bgcolor="#868789">
    	<tr>
        	<td height="300px"><img src="http://www.uv-mexico.com.mx/imagesAdidas/mail/bienvenida.png"/></td>
        </tr>

        <tr bgcolor="#868789">
        	<td align="center" height="200px">

<p class="usuarioMail">Tu usuario: <label>'.$_REQUEST['email'].'</label></p>
					<p class="usuarioMail">Tu contraseña:<label>'. $_REQUEST['password'].'</label></p>
        ...
        <tr>
        	<td>
				...
				mail( $mail, "Registro exitoso", $message, $headers);
